<template>
  ...
  >
    <v-parallax
      ...
      class=""
    >
      <v-row class="skills-row justify-center ma-0 pt-12 pb-16 h-100">
  
        <h3 class="w-100 text-center text-h3 py-8">
          Technologies I Work With
        </h3>
        
        <!-- NUXT -->
        <div class="logo-container d-flex flex-column justify-center align-center">
          <svg style="width: 80px; height: 80px;" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000">
